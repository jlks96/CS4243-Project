...
if __name__ == "__main__":
    ...
    param = "15_GAB_0.999_0.475_ALL"
    i = "0"
    character = "waldo"
    component = "head"

    classifier_path = os.path.join("trained_models", param, i, character, component, "cascase.xml")
    image_idx = "011"
    image_path = os.path.join("..", "datasets", "JPEGImages", image_idx + ".jpg")
    template_path = os.path.join("..", "datasets", "templates", character, component)
    output_path = os.path.join("trained_models", param, i, character, component)
    prelim_results = cascade_classify(classifier_path, image_path, image_idx)
    template_matching(prelim_results, image_path, template_path, output_path)
